package com.javamind.rules.step1.dbunit.rule;
...
public class DbUnitRule extends ExternalResource {
    ...
    public DbUnitRule assertTableInDatabaseIsEqualToXmlDataset(String tableName, String pathDataSetExpected, String... includedColumns) {
        try {
